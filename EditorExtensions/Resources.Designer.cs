...
namespace MadsKristensen.EditorExtensions {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Trim over qualified selectors.
        /// </summary>
        internal static string OverQualifiedSmartTagActionName {
            get {
                return ResourceManager.GetString("OverQualifiedSmartTagActionName", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Performance: Don&apos;t over qualify selectors. Remove all selectors before &quot;{0}&quot; ({1}). ID&apos;s must only occur once per web page and doesn&apos;t need further qualification..
        /// </summary>
        internal static string PerformanceDontOverQualifySelectors {
            get {
                return ResourceManager.GetString("PerformanceDontOverQualifySelectors", resourceCulture);
            }
        }
