...
namespace MadsKristensen.EditorExtensions
{
    internal class ColorConverterSmartTagAction : CssSmartTagActionBase
    {
        ...
        public ColorConverterSmartTagAction(ITrackingSpan span, ParseItem item, ColorModel colorModel, ColorFormat format)
        {
            ...
            if (Icon == null)
            {
                Icon = BitmapFrame.Create(new Uri("pack://application:,,,/WebEssentials2012;component/Resources/palette.png", UriKind.RelativeOrAbsolute));
            }
        ...
        public override void Invoke()
        {
            ...
            switch (_format)
            {
                ...
                case ColorFormat.Rgb:
                    ...
                    value = ColorFormatter.FormatColorAs(_colorModel, ColorFormat.Rgb);
                    break;

                case ColorFormat.RgbHex3:
                case ColorFormat.RgbHex6:
                    _colorModel.Format = ColorFormat.RgbHex3;
                    value = ColorFormatter.FormatColorAs(_colorModel, ColorFormat.RgbHex3);
                    break;
            }
        ...
        private void SetDisplayText()
        {
            ...
            {
                case ColorFormat.Rgb:
                    _displayText = string.Format(CultureInfo.InvariantCulture, format, ColorFormatter.FormatColorAs(_colorModel, ColorFormat.Rgb));
                    break;
                ...
                case ColorFormat.RgbHex3:
                case ColorFormat.RgbHex6:
                    _displayText = string.Format(CultureInfo.InvariantCulture, format, ColorFormatter.FormatColorAs(_colorModel, ColorFormat.RgbHex3));
                    break;
            }
        }
